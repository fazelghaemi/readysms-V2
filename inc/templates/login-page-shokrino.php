...
<body>
<div class="form-structor flex-center">
    <?php
    ...
    <div id="login" class="woocommerce-form woocommerce-form-login login form-login-otino flex-center">
        <img class="logo-otino-login" src="<?php echo otino_option('site_logo'); ?>" alt="Logo">
        <span class="title-under-logo-login-otino">
            <?php
            if ($lock_status) {
        ...
        <p class="desc-above-form-login-otino otp-activated">
        ...
        <?php
        if (!$lock_status) { ?>
        <p class="desc-above-form-login-otino">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        function handleOtpActive(el) {
            ...
            if (previousSibling && previousSibling.tagName === 'P') {
                ...
                document.querySelector('.form-login-otino').classList.add('otp-activated');
            }
        }
        function handleUndoOtpActive(el) {
            ...
            if (previousSibling && previousSibling.tagName === 'P') {
                ...
                document.querySelector('.form-login-otino').classList.remove('otp-activated');
            }
        }
